...
Kodaikanal Solar Observatory (KoSO) is a facility of Indian Institute of Astrophysics (IIA), Bangalore, India. This data is now available for public use at \url{http://kso.iiap.res.in} through a service developed at IUCAA under the Data Driven Initiatives project funded by the National Knowledge Network (NKN).
